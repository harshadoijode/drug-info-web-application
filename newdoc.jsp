...
<div align="center">
  ...
  <%@ include file="db.jsp"  %>
  <br />
  <span class="style11">New Users Registration Form</span></div>
<form id="form1" name="form1" method="post" action="">
  <table bgcolor="#311432" width="430" height="272" border="0" align="center">
    <tr>
      <td width="206"><div align="right"><span class="style9">Name : </span></div></td>
      <td width="214"><div align="left"><span class="style3">
...
try{
int x=stmt.executeUpdate("insert into patient  value('"+request.getParameter("s1")+"','"+request.getParameter("s2")+"','"+request.getParameter("s3")+"','"+request.getParameter("s4")+"')");
if(x!=0){
out.print("doctor Registered successfully");
}
}catch(Exception e){
